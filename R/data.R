...
#'   \item{colorRGB}{Primary RGB color value associated with the year in
#'     character format.}
#'   \item{contrastColorRGB}{Contrasting RGB color value (in character format)
...
#'
#' A deduplicated dataset of artists represented in the Triple J Hottest 100,
#'   created from \code{tracks}.
#'
...
#' \describe{
#'   \item{alltime}{Logical; indicates if the entry is from an all-time chart
#'     or specific year.}
#'   \item{artist}{Character; name of the artist or band associated with
#'     the track.}
